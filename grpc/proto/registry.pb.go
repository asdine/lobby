...
type RegistryServiceClient interface {
	Create(ctx context.Context, in *NewBucket, opts ...grpc.CallOption) (*proto2.Empty, error)
}
...
func (c *registryServiceClient) Create(ctx context.Context, in *NewBucket, opts ...grpc.CallOption) (*proto2.Empty, error) {
...
type RegistryServiceServer interface {
	Create(context.Context, *NewBucket) (*proto2.Empty, error)
}
